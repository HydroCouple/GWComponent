...
#The GWComponent is a stream surface transient storage zone temperature and solute transport model.
...
contains(DEFINES,GWCOMPONENT_LIBRARY){
  TEMPLATE = lib
  message("Compiling GWComponent as library")
} else {
  TEMPLATE = app
  CONFIG-=app_bundle
  message("Compiling GWComponent as application")
}
...
HEADERS += ./include/stdafx.h\
           ...
           ./include/variable.h \
           ./include/test/gwcomponenttest.h \
           ./include/gwmodel.h \
           ./include/element.h \
...
RESOURCES += resources/gwcomponent.qrc
